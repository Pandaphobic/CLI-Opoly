...
const page2 = (screen: any) => {
  ...
  turn_history = grid_page_2.set(4, 3, 3, 3, blessed.log, {
    style: {
      focus: {
        border: {
          fg: "blue",
...
export function logTurn(message: string) {
  // page2.turn_history.log(message);
  // console.log(message);
}
